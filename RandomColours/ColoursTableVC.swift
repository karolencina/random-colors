...
//  RandomColours
//
//  Created by Karolina Lencina on 19/06/2023.
//
...
class ColoursTableVC: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destVC = segue.destination as? ColorsDetailVC {
            ...
            print("Error: Destination view controller is not of type ColorsDetailVC")
        }
    }
}
...
extension ColoursTableVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return colors.count // Return 50 dynamically (bc colors containts 50 items)
    }
